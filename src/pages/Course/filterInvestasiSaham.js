    ...
    return (
        ...
        <ButtonGroup className="me-2" aria-label="First group" style={{marginTop:"100px"}}>
            ...
            <img src={require('../../image/garis1.png')} />
              ...
              <Row  xs={2} md={4} lg={3} style={{ color:"#ffff"}}> 
            <Col sm><Card style={{ width: '18rem' ,backgroundColor:"#332F2F",boxShadow: "3px 2px 1px white",marginTop:"10px"}}>
