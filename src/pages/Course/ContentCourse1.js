...
function ContentCourse1() {
    return (
      ...
      <Layout title="Tanam Uang | Home" showFooter showNavbar>
          ...
          <Container className="home-content">
            <Row>
              ...
              <Col md={5} style={{ paddingBottom: 20, paddingLeft: 100 }}>
                <img src={require('../../image/course1.png')} 
                  alt="home pic"
                  className="img-fluid"
                ...
                <strong>Mengenal Tentang </strong>
                <strong>Sektor Teknologi</strong>
                </h3>
              </Col>
        ...
        <h3 >Tentang Cours</h3>
        <p>
        Sektor teknologi adalah sektor pendatang baru yang banyak menarik perhatian investor. Hal ini dikarenakan, sektor teknologi menyimpan banyak potensi di masa yang akan datang. Perusahaan seperti e-commerce, jasa dan konsultan TI, sampai ke bank digital akan menjadi masa depan ekonomi 4.0.</p>
        <p>Modul Mengenal Sektor Teknologi ini cocok untuk kamu yang mau belajar potensi sektor teknologi di masa depan. Melalui modul ini, kamu akan mempelajari:</p>
        <ol>
            <li>Potensi perusahaan teknologi di Indonesia</li>
            <li>Indikator kinerja perusahaan teknologi</li>
            <li>Menghitung valuasi untuk perusahaan teknologi</li>
        </ol>
        <p>Setelah menyelesaikan modul ini, kamu dapat mengerti prospek perusahaan teknologi dan menghitung valuasi perusahaan teknologi.. Selamat belajar</p>
        </Card>
    </div>
    ...
    <Card style={{backgroundColor:"transparent", textAlign:"left",width:"400px", paddingTop:"10px"}}>
      ...
      <fieldset disabled>
        ...
        <Card.Header>Mengenal Sektor Teknologi <AiOutlineCaretDown/></Card.Header>
          <Form.Check 
            type="checkbox"
