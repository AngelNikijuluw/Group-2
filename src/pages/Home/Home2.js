...
<section style={{ marginTop: "90px", width: "1455px" }}>
    ...
    <section style={{ marginTop: "100px" }}>
                ...
                <section className="justify-content-md-center" style={{ marginTop: "100px", textAlign: "center" }}>
                    ...
                    </section><section style={{ marginTop: "20px", marginLeft: "50px", textAlign: "center", boxShadow: "3px 2px 1px white", borderRadius: "15px 15px 15px 15px", width: "926px", height: "220px", }}>
